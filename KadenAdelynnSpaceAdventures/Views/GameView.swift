...
struct GameView: View {
    ...
    var body: some View {
        GeometryReader { geometry in
            ...
            .onAppear {
                ...
                // Track daily challenge - game started
                trackDailyChallengeGameStart()
            }
    ...
    private func redesignedScoreboard(geometry: GeometryProxy) -> some View {
        ...
        let topPadding = isLandscape ? max(geometry.safeAreaInsets.top + 6, 12) : max(geometry.safeAreaInsets.top + 8, 64)
        ...
        VStack(spacing: 0) {
            ...
            .frame(height: isLandscape ? 84 : 92)
        ...
        ZStack {
            ...
            VStack(spacing: 30) {
                ...
                VStack(spacing: 15) {
                    ...
                    .accessibilityHint("Double tap to resume playing")
                    .accessibilityAddTraits(.isButton)
                    ...
                    .accessibilityHint("Double tap to save your current game progress")
                    .accessibilityAddTraits(.isButton)
                    ...
                    .accessibilityHint("Double tap to exit to the main menu")
                    .accessibilityAddTraits(.isButton)
                }
            }
        }
    ...
    // MARK: - Controller Status Indicator
    @ViewBuilder
    private func controllerStatusIndicator(geometry: GeometryProxy) -> some View {
        VStack {
            Spacer()
            HStack {
                HStack(spacing: 8) {
    ...
    private func trackDailyChallengeGameStart() {
