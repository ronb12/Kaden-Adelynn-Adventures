...
struct ShipSelectView: View {
    ...
    let ships: [Ship] = [
        ...
        Ship(id: "viper", icon: "🐍", name: "Viper", weapon: "Shotgun", speed: "High", durability: "Medium", firepower: "High", maneuverability: "High", color1: .green, color2: .mint, cost: 300, isDefault: false, category: .dps, description: "Close-range specialist with devastating shotgun blasts.", playstyle: "Best for: Aggressive players", speedValue: 7.5, healthValue: 90, damageValue: 1.25, unlockRequirement: "Get 10 combo clears", unlockProgress: nil),
        ...
        Ship(id: "starblade", icon: "S", name: "Starblade", weapon: "Twin Laser", speed: "Very High", durability: "Medium", firepower: "High", maneuverability: "Very High", color1: .cyan, color2: .purple, cost: 420, isDefault: false, category: .speed, description: "A neon interceptor with twin-prong wings and razor-fast handling.", playstyle: "Best for: Agile pilots", speedValue: 9.0, healthValue: 90, damageValue: 1.25, unlockRequirement: "Reach Wave 12", unlockProgress: nil),
        Ship(id: "nebula", icon: "N", name: "Nebula Guardian", weapon: "Pulse Cannon", speed: "Medium", durability: "Very High", firepower: "Very High", maneuverability: "Medium", color1: .indigo, color2: .mint, cost: 460, isDefault: false, category: .tank, description: "A shield ship with broad armor fins and a luminous reactor core.", playstyle: "Best for: Durable firepower", speedValue: 6.0, healthValue: 140, damageValue: 1.35, unlockRequirement: "Score 25,000 points", unlockProgress: nil)
    ]
...
private struct EnhancedShipCard: View {
    ...
    var bestStat: String {
        ...
        default:
            let stats = [
                ("Speed", ship.speedValue / 10.0),
                ("Armor", Double(ship.healthValue) / 150.0),
                ("Damage", ship.damageValue / 1.4),
                ("Handling", parseManeuverability(ship.maneuverability))
            ]
        ...
        Button(action: onSelect) {
            VStack(spacing: 10) {
                ...
                LazyVGrid(columns: [
                    ...
                    ShipDetailPill(label: "Speed", value: String(format: "%.1f", ship.speedValue))
                    ShipDetailPill(label: "HP", value: "\(ship.healthValue)")
                    ShipDetailPill(label: "Damage", value: "\(String(format: "%.2f", ship.damageValue))x")
                    ShipDetailPill(label: "Weapon", value: ship.weapon)
                }
...
private struct ShipDetailPill: View {
    let label: String
    let value: String
