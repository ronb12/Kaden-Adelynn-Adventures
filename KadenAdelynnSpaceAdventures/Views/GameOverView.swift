...
struct GameOverView: View {
                ...
                VStack(spacing: 18) {
                    ...
                    VStack(spacing: 10) {
                        ...
                        Text("Game Over")
                            ...
                            .shadow(color: (colorScheme == .dark ? Color.white : Color.black).opacity(0.8), radius: 5, x: 0, y: 2)
                            .lineLimit(1)
                    ...
                    if !achievementsUnlocked.isEmpty {
                        VStack(alignment: .leading, spacing: 12) {
                            Label("Achievements Unlocked", systemImage: "trophy.fill")
                                .font(.headline)
                                .foregroundColor(.white)
                                .shadow(color: .black.opacity(0.8), radius: 3, x: 0, y: 1)
                                .padding(.horizontal)
    ...
    private func trackDailyChallengeGameComplete() {
        ...
        gamesToday += 1
        UserDefaults.standard.set(gamesToday, forKey: "gamesToday")
        UserDefaults.standard.set(today, forKey: "lastPlayDate")
