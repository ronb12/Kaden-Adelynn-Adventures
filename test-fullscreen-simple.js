...
async function testFullscreenGameplay() {
  ...
  try {
    ...
    if (mobileDimensions) {
      console.log(
        mobileDimensions.isFullscreen
          ? '✅ Mobile: Canvas is fullscreen'
          : '❌ Mobile: Canvas is NOT fullscreen'
      )
    }
    ...
    if (desktopDimensions) {
      console.log(
        desktopDimensions.isFullscreen
          ? '✅ Desktop: Canvas is fullscreen'
          : '❌ Desktop: Canvas is NOT fullscreen'
      )
    }
