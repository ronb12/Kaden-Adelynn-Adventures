    ...
    var body: some View {
        Button(action: onSelect) {
            VStack(spacing: 10) {
                ...
                // Animated character art without a separate portrait backplate
                ZStack {
                    // Original character art, cycling small limb-pose frames for motion
                    AnimatedCharacterSprite(characterId: character.id)
                        .frame(width: 110, height: 150)
                        .scaleEffect(isSelected ? 1.05 : pulseScale)
        ...
        .onAppear {
            ...
            // Keep the card steady; only the character gently bounces.
            withAnimation(
...
private struct AnimatedCharacterSprite: View {
...
private struct StaticCharacterSprite: View {
    let characterId: String
