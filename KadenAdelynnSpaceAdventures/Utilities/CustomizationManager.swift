...
class CustomizationManager {
    ...
    static func getTrailColors(trailName: String) -> (UIColor, CGFloat) {
        ...
        case "comet", "comet tail":
            return (UIColor(red: 0.55, green: 0.9, blue: 1.0, alpha: 1.0), 1.65)
        case "heart", "heart trail":
            return (UIColor(red: 1.0, green: 0.22, blue: 0.48, alpha: 1.0), 1.35)
        default: // "default"
    ...
    static func getBulletColors(bulletName: String) -> (UIColor, UIColor) {
        ...
        case "starburst":
            return (UIColor(red: 1.0, green: 0.84, blue: 0.0, alpha: 1.0), UIColor(red: 1.0, green: 0.95, blue: 0.45, alpha: 1.0))
        case "love", "love beam":
            return (UIColor(red: 1.0, green: 0.22, blue: 0.48, alpha: 1.0), UIColor(red: 1.0, green: 0.58, blue: 0.78, alpha: 1.0))
        default: // "default"
    ...
    static func getThemeColors(themeName: String) -> (backgroundColor: UIColor, starColor: UIColor, starBrightness: CGFloat) {
        ...
        case "aurora":
            return (
                backgroundColor: UIColor(red: 0.02, green: 0.08, blue: 0.18, alpha: 1.0),
                starColor: UIColor(red: 0.38, green: 1.0, blue: 0.86, alpha: 1.0),
                starBrightness: 0.95
            )
        default: // "default"
            return (
