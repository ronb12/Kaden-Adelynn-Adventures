...
struct ShipSelectView: View {
    ...
    let ships: [Ship] = [
        Ship(id: "kaden", icon: "🚀", name: "Kaden's Ship", weapon: "Laser", speed: "High", durability: "Medium", firepower: "Medium", maneuverability: "High", color1: .cyan, color2: .blue, cost: 0, isDefault: true, category: .starter, description: "A balanced starter ship perfect for beginners. Reliable and versatile.", playstyle: "Best for: Beginners", speedValue: 7.0, healthValue: 100, damageValue: 1.0, unlockRequirement: nil, unlockProgress: nil),
