...
class SkinManager {
    ...
    static func getSkinColors(skinName: String, baseShipColor: UIColor? = nil, baseAccentColor: UIColor? = nil) -> SkinColors {
        ...
        case "starlight":
            return SkinColors(
                shipColor: UIColor(red: 0.78, green: 0.96, blue: 1.0, alpha: 1.0),
                accentColor: UIColor(red: 1.0, green: 0.88, blue: 0.32, alpha: 1.0),
                glowColor: UIColor(red: 0.72, green: 0.95, blue: 1.0, alpha: 0.9),
                glowIntensity: 30.0,
                hasPulse: true,
                pulseSpeed: 4.0,
                hasShine: true,
        ...
        case "void", "void runner":
            return SkinColors(
                shipColor: UIColor(red: 0.08, green: 0.05, blue: 0.22, alpha: 1.0),
                accentColor: UIColor(red: 0.72, green: 0.22, blue: 1.0, alpha: 1.0),
                glowColor: UIColor(red: 0.62, green: 0.10, blue: 1.0, alpha: 0.75),
                glowIntensity: 26.0,
                hasPulse: true,
                pulseSpeed: 5.0,
                hasShine: false,
